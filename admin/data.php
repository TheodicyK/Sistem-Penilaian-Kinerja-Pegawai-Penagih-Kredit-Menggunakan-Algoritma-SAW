...
if (isset($_POST['delete'])) {
    ...
    $delete_query = "DELETE FROM tb_datanasabah WHERE id = $delete_id";
...
<body>
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav nav-pills">
                    ...
                    <li> 
                        <button onclick="customPrintFunction()" class="btn btn-outline-primary me-2">Print</button>
                        <script>
    ...
    <div class="card custom-card">
        <table id="laporan-table" class="table table-bordered table-responsive-sm">
            ...
            <tbody>
                <?php
                $rows = mysqli_query($koneksi, "SELECT * FROM tb_datanasabah ORDER BY id DESC");
                $i = 1;
                foreach ($rows as $row) :
                ?>
                <tr>
